<?php
$titleArray = array(__('Transcribe'), __('Page Revision'));
...
<div id="primary">
    ...
    <div id="scripto-history" class="scripto">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="#"><?php echo __('Revisions'); ?></a></li>
...
if ($this->scripto->canProtect()) :
            echo $this->formSubmit('scripto-page-revert', __('Revert to this revision'), array('style' => 'display:inline; float:none;'));
endif; ?>
        </form>
        <?php endif; ?>
